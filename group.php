	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Groups</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Group </button>
				</div> <!-- /div-action -->				
...
<div class="modal fade" id="addBrandModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="" action="php_action/addgroup.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Group Name: </label>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createBrandBtn"  autocomplete="off">Save Changes</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	<label for="editBrandName" class="col-sm-3 control-label">Group Name: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
...
<script src="custom/js/groups.js"></script>
